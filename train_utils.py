...
def svd(edge_list, n_nodes, window=5,dim=128):
...
def n2v(edge_list, embedding_dim=128, walk_length=10,
        context_size=5, walks_per_node=10,tol=1e-4,verbose=False, max_iter=5):
...
def gnn(edge_list,X, fanouts = [10,25], use_rw=True, embedding_dim=128, walk_length=10,
        context_size=5, walks_per_node=10, tol=1e-4,verbose=False):
